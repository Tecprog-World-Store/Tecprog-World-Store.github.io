...
const carouselData = {
  cursos: [
    item("delft3d-wave-flow", "Delft3D Wave and Flow", "TW Educa", "Modelamiento numérico", "Curso aplicado para modelamiento hidrodinámico, oleaje y análisis costero con enfoque técnico.", "Desde USD 16", "", "Virtual en vivo / grabado", "assets/img/cursos/miniaturas/delft3d-wave-flow.webp?v=img-final-20260628", "detalle/curso.html?id=delft3d-wave-flow&periodo=2026-06"),
    item("admision-unac", "Preparación examen de admisión UNAC", "TW Educa", "Preparación académica", "Programa para modalidades especiales con práctica guiada, materiales y orientación por objetivos.", "Desde USD 16", "", "Virtual / grabado", "assets/img/cursos/miniaturas/admision-unac.webp?v=img-final-20260628", "detalle/curso.html?id=admision-unac&periodo=2026-06"),
    item("matlab-programacion", "Programación de MATLAB", "TW Educa", "Programación científica", "Fundamentos, scripts, funciones, gráficos y métodos de cálculo para ingeniería y ciencia.", "Desde USD 16", "", "Virtual / grabado", "assets/img/cursos/miniaturas/matlab-programacion.webp?v=img-final-20260628", "detalle/curso.html?id=matlab-programacion&periodo=2026-06"),
    item("openfoam-cfd", "CFD con OpenFOAM", "TW Educa", "CFD e ingeniería", "Introducción práctica al flujo de trabajo CFD para casos educativos y simulación técnica.", "Desde USD 16", "", "Virtual / grabado", "assets/img/cursos/miniaturas/cfd-introductorio-openfoam.webp?v=img-final-20260628", "detalle/curso.html?id=openfoam-cfd&periodo=2026-06"),
    item("python-poo", "Programación Orientada a Objetos con Python", "TW Educa", "Software", "Clases, objetos, módulos, buenas prácticas y automatización con ejemplos aplicados.", "Desde USD 16", "", "Virtual / grabado", "assets/img/servicios/cursos_ingenieros_y_cientificos/Curso_Python01.webp", "detalle/curso.html?id=python-poo&periodo=2026-06"),
    item("hp50g", "Programación HP 50G", "TW Educa", "Calculadoras científicas", "Programación aplicada para automatizar cálculos y rutinas técnicas en HP 50G.", "Desde USD 7", "", "Virtual / grabado", "assets/img/servicios/cursos_ingenieros_y_cientificos/Curso_Programacion_HP50G.JPG", "detalle/curso.html?id=hp50g&periodo=2026-06"),
    item("latex", "LaTeX", "TW Educa", "Redacción técnica", "Documentos técnicos, tesis, informes, ecuaciones, tablas y plantillas profesionales.", "Desde USD 16", "", "Virtual / grabado", "assets/img/cursos/taller-innovacion-prototipado.svg", "detalle/curso.html?id=latex&periodo=2026-06"),
    item("odoo-erp", "Odoo ERP", "TW Educa", "Gestión empresarial", "Introducción a módulos, ventas, inventario, clientes y procesos para pequeños negocios.", "Desde USD 16", "", "Virtual / grabado", "assets/img/software/software-comercial-campus.svg", "detalle/curso.html?id=odoo-erp&periodo=2026-06"),
    item("qgis-basico", "QGIS Básico", "TW Educa", "GIS", "Mapas, capas, simbología, procesamiento espacial y entregables para proyectos.", "Desde USD 16", "", "Virtual / grabado", "assets/img/cursos/curso-tecnologia-negocios.svg", "detalle/curso.html?id=qgis-basico&periodo=2026-06")
  ],
  software: [
    item("software-medida", "Desarrollo de software a medida", "TW Innova", "Software empresarial", "Sistemas diseñados según procesos internos, usuarios, reportes y operación real.", "Desde USD 389", "", "Proyecto por alcance", "assets/img/software/software-comercial-dashboard.svg", "detalle/software.html?id=software-medida"),
    item("sistemas-web", "Sistemas web empresariales", "TW Innova", "Web apps", "Aplicaciones web para gestión, ventas, inscripciones, reportes y atención al cliente.", "Desde USD 479", "", "Proyecto", "assets/img/software/software-comercial-campus.svg", "detalle/software.html?id=sistemas-web"),
    item("plugins-qgis", "Plugins QGIS", "TW Innova", "GIS", "Herramientas geoespaciales para automatizar procesos, validar datos y generar resultados.", "Desde USD 389", "", "Cotización técnica", "assets/img/servicios/servicio-implementacion-tecnologica.svg", "detalle/software.html?id=plugins-qgis"),
    item("plugins-autocad", "Plugins AutoCAD", "TW Innova", "CAD", "Automatizaciones y rutinas para dibujo técnico, documentación y productividad.", "Desde USD 419", "", "Cotización técnica", "assets/img/software/software-open-source-tools.svg", "detalle/software.html?id=plugins-autocad"),
    item("dashboards", "Dashboards", "TW Innova", "Analítica", "Paneles para visualizar indicadores, ventas, operaciones, proyectos y datos técnicos.", "Desde USD 289", "", "Remoto", "assets/img/software/software-comercial-dashboard.svg", "detalle/software.html?id=dashboards")
  ],
  servicios: [
    item("simulaciones-cfd", "Simulaciones CFD", "TW Innova", "Ingeniería aplicada", "Modelamiento, análisis y visualización de flujos para estudios técnicos especializados.", "Desde USD 479", "", "Consultoría", "assets/img/servicios/servicio-implementacion-tecnologica.svg", "detalle/servicio.html?id=simulaciones-cfd"),
    item("modelamiento-hidraulico", "Modelamiento hidráulico", "TW Innova", "Hidráulica", "Evaluación técnica de sistemas hidráulicos, cauces, canales y escenarios de análisis.", "Desde USD 389", "", "Consultoría", "assets/img/banners/hero-tech.svg", "detalle/servicio.html?id=modelamiento-hidraulico"),
    item("estudios-gis", "Estudios GIS", "TW Innova", "Geoespacial", "Procesamiento de capas, mapas, análisis espacial y entregables para proyectos.", "Desde USD 229", "", "Remoto", "assets/img/cursos/curso-tecnologia-negocios.svg", "detalle/servicio.html?id=estudios-gis"),
    item("procesamiento-datos", "Procesamiento de datos", "TW Innova", "Datos", "Limpieza, transformación, automatización y reportes para equipos técnicos y empresas.", "Desde USD 199", "", "Remoto", "assets/img/servicios/servicio-soporte-tecnico.svg", "detalle/servicio.html?id=procesamiento-datos"),
    item("expedientes-tecnicos", "Expedientes técnicos", "TW Construye", "Construcción", "Apoyo en documentación, metrados, presupuestos y revisión técnica por alcance.", "Desde USD 289", "", "Cotización", "assets/img/servicios/servicio-desarrollo-software.svg", "detalle/servicio.html?id=expedientes-tecnicos")
  ],
  salud: [
    item("protesis", "Diseño de prótesis", "TW Salud", "Prototipado biomédico", "Diseño, modelado y apoyo técnico para soluciones protésicas personalizadas.", "Desde USD 99", "", "Evaluación previa", "assets/img/servicios/protesis_y_ortesis/TW_Salud_prtesis_manos.webp", "detalle/servicio.html?id=protesis"),
    item("ortesis", "Diseño de órtesis", "TW Salud", "Tecnología médica", "Soporte técnico para diseño de órtesis, ajustes funcionales y prototipos.", "Desde USD 89", "", "Evaluación previa", "assets/img/servicios/protesis_y_ortesis/TW_Salud_y_Vida_Prtesis_de_Pierna01.webp", "detalle/servicio.html?id=ortesis"),
    item("cad-biomedico", "Modelado CAD biomédico", "TW Salud", "CAD", "Modelado 3D, piezas funcionales y preparación para fabricación o impresión 3D.", "Desde USD 59", "", "Remoto", "assets/img/servicios/protesis_y_ortesis/TW_salud_y_vida_servicio_de_mantenimiento.png", "detalle/servicio.html?id=cad-biomedico"),
    item("impresion-3d", "Impresión 3D", "TW Salud", "Prototipado", "Prototipos físicos, pruebas de forma y fabricación por coordinación técnica.", "Desde USD 49", "", "Cotización", "assets/img/servicios/protesis_y_ortesis/TW_Salud_y_Vida_Mantenimiento_Unidad_Dental.webp", "detalle/servicio.html?id=impresion-3d")
  ],
  productos: [
    item("plantillas-digitales", "Plantillas digitales", "TW Store", "Recurso digital", "Plantillas para organizar cursos, ventas, reportes, presupuestos y entregables.", "Desde USD 11", "", "Descarga digital", "assets/img/productos/producto-solucion-digital.svg", "detalle/producto.html?id=plantillas-digitales"),
    item("manuales-pdf", "Manuales PDF", "TW Educa", "Material educativo", "Materiales técnicos para cursos, talleres, ingeniería, programación y herramientas digitales.", "Desde USD 11", "", "Descarga digital", "assets/img/descargas/descarga-manual-pdf.svg", "detalle/material.html?id=manuales-pdf"),
    item("recursos-ingenieria", "Recursos para ingeniería", "TW Store", "Pack digital", "Archivos, guías, hojas de cálculo, scripts y recursos de apoyo técnico.", "Desde USD 17", "", "Entrega digital", "assets/img/descargas/descarga-recursos-educativos.svg", "detalle/producto.html?id=recursos-ingenieria"),
    item("packs-cursos", "Packs de cursos", "TW Educa", "Formación", "Paquetes de cursos y materiales para rutas de aprendizaje especializadas.", "Desde USD 49", "", "Virtual", "assets/img/productos/producto-kit-emprendedor.svg", "detalle/producto.html?id=packs-cursos"),
    item("licencias-demos", "Licencias o demos", "TW Innova", "Software", "Acceso a versiones comerciales, demos, instaladores o soluciones configurables.", "Desde USD 39", "", "Digital", "assets/img/descargas/descarga-instalador-demo.svg", "detalle/software.html?id=licencias-demos")
  ]
};
    ...
    <article class="catalog-card reveal" role="listitem" data-course-card-id="${safeText(entry.id)}">
      ...
      <div class="catalog-body">
        ...
        <div class="catalog-meta">
          <span>${entry.line === "TW Educa" ? "Matrícula abierta · " : ""}${safeText(entry.modality)}</span>
