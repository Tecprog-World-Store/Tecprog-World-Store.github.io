...
const carouselData = {
  ...
  salud: [
    item("protesis", "Diseño de prótesis", "TW Salud", "Prototipado biomédico", "Diseño, modelado y apoyo técnico para soluciones protésicas personalizadas.", "Desde S/ 300", "Desde USD 90 vía PayPal", "Evaluación previa", "assets/img/servicios/protesis_y_ortesis/TW_Salud_prtesis_manos.webp", "detalle/servicio.html?id=protesis"),
    item("ortesis", "Diseño de órtesis", "TW Salud", "Tecnología médica", "Soporte técnico para diseño de órtesis, ajustes funcionales y prototipos.", "Desde S/ 250", "Desde USD 75 vía PayPal", "Evaluación previa", "assets/img/servicios/protesis_y_ortesis/TW_Salud_y_Vida_Prtesis_de_Pierna01.webp", "detalle/servicio.html?id=ortesis"),
    ...
    item("impresion-3d", "Impresión 3D", "TW Salud", "Prototipado", "Prototipos físicos, pruebas de forma y fabricación por coordinación técnica.", "Desde S/ 120", "Desde USD 40 vía PayPal", "Cotización", "assets/img/servicios/protesis_y_ortesis/TW_Salud_y_Vida_Mantenimiento_Unidad_Dental.webp", "detalle/servicio.html?id=impresion-3d")
  ],
  productos: [
