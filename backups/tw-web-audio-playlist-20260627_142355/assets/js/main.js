...
function setupAudioPlayer() {
  ...
  pause?.addEventListener("click", () => {
    audio.pause();
    if (play) play.textContent = "Activar música";
  });
